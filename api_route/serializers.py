...
class RouteSerializer(serializers.ModelSerializer):
    ...
    another_origin_name = serializers.ReadOnlyField(source = 'another_origin.name')
    ...
    class Meta:
        ...
        read_only_fields = ('origin_name', 'another_origin_name', 'destination_name', 'another_destin_name')
